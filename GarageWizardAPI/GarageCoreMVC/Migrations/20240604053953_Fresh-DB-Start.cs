...
namespace GarageCoreMVC.Migrations
{
    ...
    public partial class FreshDBStart : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobImagePath = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RegID = table.Column<string>(type: "text", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    Vendor = table.Column<string>(type: "text", nullable: false),
                    Wheels = table.Column<int>(type: "integer", nullable: false),
                    ParkStart = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vehicles", x => x.RegID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<string>(type: "text", nullable: false),
                    ParkStart = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ParkEnd = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Service = table.Column<int>(type: "integer", nullable: false),
                    VehicleID = table.Column<string>(type: "text", nullable: true),
                    SpotID = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Parkings", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Parkings_Spots_SpotID",
                        column: x => x.SpotID,
